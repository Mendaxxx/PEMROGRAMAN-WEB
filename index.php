    ...
    <body id="page-top">
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">Hello perkenalkan saya Daffa Bintang Pratama.Lahir di Depok Pada Tanggal 21 April 2000. </p></div>
                    <div class="col-lg-4 mr-auto"><p class="lead">Saya merupakan Mahasiswa Jurusan Teknik Informatika,Universitas Pembangunan Jaya.</p></div>
                </div>
